...
from frozensearch import webapp
from frozensearch.testing import frozensearchTestCase


class ViewsTestCase(frozensearchTestCase):
    ...
    def test_index_empty(self):
        ...
        self.assertIn('<div class="title"><h1>frozensearch</h1></div>', result.data)

    @patch('frozensearch.search.Search.search')
    ...
    def test_index_rss(self, search):
        ...
        self.assertIn(
            '<description>Search results for "test" - frozensearch</description>',
            result.data
        )
    ...
    def test_about(self):
        ...
        self.assertEqual(result.status_code, 200)
        self.assertIn('<h1>About <a href="/">frozensearch</a></h1>', result.data)
    ...
    def test_opensearch_xml(self):
        ...
        self.assertEqual(result.status_code, 200)
        self.assertIn('<Description>Search frozensearch</Description>', result.data)
