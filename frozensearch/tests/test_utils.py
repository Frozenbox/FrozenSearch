...
from frozensearch import utils


class TestUtils(frozensearchTestCase):
...
class TestHTMLTextExtractor(frozensearchTestCase):
...
class TestUnicodeWriter(frozensearchTestCase):
