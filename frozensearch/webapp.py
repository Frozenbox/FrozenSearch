...
from frozensearch import settings, frozensearch_dir
from frozensearch.engines import (
    categories, engines, get_engines_stats, engine_shortcuts
)
from frozensearch.utils import (
    UnicodeWriter, highlight_content, html_to_text, get_themes
)
from frozensearch.version import VERSION_STRING
from frozensearch.languages import language_codes
from frozensearch.https_rewrite import https_url_rewrite
from frozensearch.search import Search
from frozensearch.query import Query
from frozensearch.autocomplete import backends as autocomplete_backends


static_path, templates_path, themes =\
    get_themes(settings['themes_path']
               if settings.get('themes_path')
               else frozensearch_dir)
...
for indice, theme in enumerate(themes):
    ...
    theme_img_path = frozensearch_dir+"/static/"+theme+"/img/"
...
def render(template_name, override_theme=None, **kwargs):
    ...
    kwargs['frozensearch_version'] = VERSION_STRING
...
def index():
    ...
    if search.request_data.get('format') == 'json':
        ...
        cont_disp = 'attachment;Filename=frozensearch_-_{0}.csv'.format(search.query)
